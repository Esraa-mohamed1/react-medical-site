...
export default function AuthForm({ variant = 'login', onSubmit, serverError }) {
  ...
  const handleGoogleLogin = () => {
    ...
    try {
      ...
      const googleAuthUrl = 'http://localhost:8000/social/login/google-oauth2/?prompt=select_account';
  ...
  return (
    <>
      ...
      <div className="auth-page">
        {variant === 'login' && <div className='auth-container' style={{ width: '90%' }}>
            ...
            <h2 className="auth-title">
              <span className="auth-title-icon" aria-hidden="true">
                <svg
                  ...
                  viewBox="0 0 24 24"
                >
                  <path d="M10 12c2.21 0 4-1.79 4-4s-1.79-4-4-4S6 5.79 6 8s1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4
          v2h16v-2c0-2.66-5.33-4-8-4z" />
            ...
            <button
              type="submit"
              className="btn btn-light custom-btn mb-2"
              style={{ width: '46%' }}>
        ...
        {variant != 'login' && <div className='auth-container' style={{ width: '30%', margin: '2rem 0' }}>
          <form className="auth-section auth-card" onSubmit={handleSubmit} noValidate>
            <h2 className="auth-title">
              <span className="auth-title-icon" aria-hidden="true">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
